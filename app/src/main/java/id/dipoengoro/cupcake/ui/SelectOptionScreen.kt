...
fun SelectOptionScreen(
    ...
    Column(modifier = modifier, verticalArrangement = Arrangement.SpaceBetween) {
        Column(modifier = Modifier.padding(Dimen.PADDING_SMALL)) {
            options.forEach { item ->
                ...
                Divider(
                    thickness = Dimen.THICKNESS_DIVIDER,
                    modifier = Modifier.padding(bottom = Dimen.PADDING_SMALL)
                )
                FormattedPriceLabel(
                    subtotal = subtotal, modifier = Modifier
                        .align(Alignment.End)
                        .padding(top = Dimen.PADDING_MEDIUM, bottom = Dimen.PADDING_MEDIUM)
                )
            }
        }
        Row(
            modifier = Modifier
                ...
                .weight(1f, false),
            horizontalArrangement = Arrangement.spacedBy(Dimen.PADDING_MEDIUM),
